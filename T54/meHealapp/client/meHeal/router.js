FlowRouter.route('/', {
    action: function() {
        BlazeLayout.render("blankLayout", {content: "letslogin"});
    }
});

FlowRouter.route('/forgot', {
    action: function() {
        BlazeLayout.render("blankLayout", {content: "forgot"});
    }
});

FlowRouter.route('/quest', {
    action: function() {
        //BlazeLayout.render("mainLayout", {content: "quest"});
        BlazeLayout.render("mainLayout", {content: "quest"});
    }
});
...
FlowRouter.route('/reg', {
    action: function() {
        BlazeLayout.render("blankLayout", {content: "reg"});
    }
});

FlowRouter.route('/resourceTab', {
    action: function() {
        BlazeLayout.render("mainLayout", {content: "resourceTab"});
    }
});
