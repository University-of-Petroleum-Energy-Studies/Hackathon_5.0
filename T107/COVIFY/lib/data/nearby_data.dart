import 'package:covid19/models/nearby/nearby_model.dart';

List<NearbyModel> nearbyModel = [
  NearbyModel(
  ...
  NearbyModel(
    ...
    description:
    'Vaccine to prevent or treat COVID-2019 is available. However, those affected should receive care to relieve symptoms. People with serious illness should be hospitalized. Most patients recover thanks to supportive care.',
  ),
  NearbyModel(
